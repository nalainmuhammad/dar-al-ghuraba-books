...
/* ─── Book Seed Data (from original books.js) ───────────── */
const books = [
  // ─── QURAN ──────────────────────────────────────────────
  {
...
const seedDatabase = async () => {
  try {
    ...
    // ─── Seed Admin User ────────────────────────────────────
    const adminEmail = process.env.ADMIN_EMAIL || 'admin@darulilmbooks.com';
    const adminPassword = process.env.ADMIN_PASSWORD || 'Admin@DarUlIlm2024';
